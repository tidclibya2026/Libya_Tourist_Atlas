...
missing=[x for x in required if not (O/x).exists()]
if not (R/'docs/national-tourism-image-governance-phase-1-report.md').exists():missing.append('docs/national-tourism-image-governance-phase-1-report.md')
if not (O/'review-sheets').is_dir():missing.append('docs/images/review-sheets/')
